...
try {
  await sendMail({
    ...
    message: `Hello ${seller.name}, Your withdrraw request of amount,${withdraw.amount}$ is on the way,Dilevry time depends on your banks rules, it usualy takes with in 3day to 7days,`
  })
} catch (error) {
         return next(new ErrorHandler(error.message,500));
